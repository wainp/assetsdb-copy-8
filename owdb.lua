...
--V.defaultCaption = "Enter Your Name..."
	...
	--					  end,
                onFocus         = function(EventData) 
							...
							if EventData.value == oname then _G.GUI.Set("INP_SAMPLE", {caption = ""} ) end
						  end,
...
_G.GUI.NewInput(
		...
		disableInput    = true,
                onFocus         = function(EventData) 
							-- CLEAR TEXT WHEN TEXT FIELD IS FOCUSED FIRST TIME:
							if EventData.value == oupdate then _G.GUI.Set("update", {caption = ""} ) end
						  end,
		-- PRESSED: SHOW WIDGET CANDY KEYBOARD
		onPress         = function(EventData)  
					_G.GUI.Keyboard_Show(
...
_G.GUI.NewInput(
		...
		disableInput    = true,
                onFocus         = function(EventData) 
							-- CLEAR TEXT WHEN TEXT FIELD IS FOCUSED FIRST TIME:
							if EventData.value == oversion then _G.GUI.Set("version", {caption = ""} ) end
						  end,
		-- PRESSED: SHOW WIDGET CANDY KEYBOARD
		onPress         = function(EventData)  
					_G.GUI.Keyboard_Show(
...
_G.GUI.NewLabel(
 ...
 _G.GUI.NewInput(
		...
		disableInput    = true,
                onFocus         = function(EventData) 
							-- CLEAR TEXT WHEN TEXT FIELD IS FOCUSED FIRST TIME:
							if EventData.value == odbversion then _G.GUI.Set("dbversion", {caption = ""} ) end
						  end,
		-- PRESSED: SHOW WIDGET CANDY KEYBOARD
		onPress         = function(EventData)  
					_G.GUI.Keyboard_Show(
