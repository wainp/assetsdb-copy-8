...
local CiderRunMode = {};CiderRunMode.runmode = 'RUN';CiderRunMode.assertImage = true;CiderRunMode.userdir = "/Users/peterwain/Library/Application Support/luaglider2/dev";local SOCKET_PORT=31447;local GLIDER_MAIN_FOLDER= "/Users/peterwain/Documents/assetsdb copy 8";local useNativePrint= false;local snapshotInterval= -1;local snapshotInterval= -1;local fileFilters= {"CiderDebugger.lua",};local startupMode= "require";local function shouldDebug()
