...
local Theme =
	...
	TooltipTextYOffset         = -2,             -- ADJUST THIS IF TOOLTIP BUBBLE TEXT (SEE SLIDER WIDGET, FOR EXAMPLE) IS NOT CENTERED WITHIN TOOLTIP BUBBLE
	...
	--------------------------------------------------------
	SwitchOnColor              = {.29,1,.29},     -- OPTIONAL COLOR OF ON/OFF SWITCHES WHEN SWITCH IS "ON"
	SwitchRange                = 7,               -- THE RANGE (IN PIXELS) THAT THE SWITCH CAN BE MOVED TO THE LEFT OR RIGHT. SET IT TO NIL TO ENABLE THE FULL RANGE (DEFAULT) OR TO 10, FOR EXAMPLE TO LET THE SWITCH MOVE 10 PIXELS TO THE LEFT OR RIGHT ONLY.
	WindowCaptionColor1        = {.07,.07,.07},   -- WINDOW TITLE CAPTION TEXT COLOR
	WindowCaptionColor2        = {.98,.98,.98},   -- WINDOW TITLE CAPTION SHADOW COLOR
	WidgetTextColor            = {.19,.19,.2},    -- THE DEFAULT TEXT COLOR OF ALL WIDGETS
	ButtonTextColor            = {0,0,0},         -- COLOR OF BUTTON TEXT CAPTIONS
	...
	SliderTickFillColor        = {0,0,0},         -- SLIDER TICKS FILL COLOR
	ListItemTextColor          = {.19,.19,.19},   -- DEFAULT LIST ITEM TEXT COLOR (YOU CAN ALSO SET INDIVIDUAL LIST ITEM COLORS)
	ListItemSelectedColor      = {0,0,0,.25},     -- SELECTED LIST ITEM BACKGROUND COLOR
