...
local Theme =
	...
	WindowCaptionColor1        = {.078,.15,.078}, -- WINDOW TITLE CAPTION TEXT COLOR
	WindowCaptionColor2        = {.94,.98,.94}, -- WINDOW TITLE CAPTION SHADOW COLOR
	WidgetTextColor            = {.19,.19,.19}, -- THE DEFAULT TEXT COLOR OF ALL WIDGETS
	ButtonTextColor            = {.19,.19,.19}, -- COLOR OF BUTTON TEXT CAPTIONS
	EmbossColorHigh            = {1,1,1},       -- USED FOR EMBOSSED THINGS LIKE BORDERS, LABEL ETC.
	...
	SliderTickFillColor        = {.58,.58,.58}, -- SLIDER TICKS FILL COLOR
	ListItemTextColor          = {0,0,0},       -- DEFAULT LIST ITEM TEXT COLOR (YOU CAN ALSO SET INDIVIDUAL LIST ITEM COLORS)
	ListItemSelectedColor      = {0,0,1,.35},   -- SELECTED LIST ITEM BACKGROUND COLOR
