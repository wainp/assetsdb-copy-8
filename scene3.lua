...
local titleText = display.newText( "Badge", halfW, titleBar.y, native.systemFontBold, 22 )
...
_G.GUI.NewIconBar(
	...
	_G.GUI.GetHandle("BAR3"):setMarker(5)
...
_G.GUI.NewIconBar(
		...
		icons           = 
			{
				{icon = 13 , flipX = false, text = "Scene3"},
				{icon = 11 , flipX = false, text = "Leaders"},
				{icon = 17, flipX = false, text = "District"},
				{icon = 38, flipX = true , text = "Badge"},
				{icon = 21, flipX = false, text = "Config"},
	...
	-- SELECT ICON NUMBER 1
	_G.GUI.GetHandle("BAR3"):setMarker(4)
