...
--_G.GUI.UnloadThemes("theme_4")
 ...
 local titleText = display.newText( "MCST New deployment", halfW, titleBar.y, native.systemFontBold, 22 )
...
_G.GUI.NewIconBar(
		...
		icons           = 
			{
				{icon = 14 , flipX = false, text = "Current"},
				{icon = 37 , flipX = false, text = "New"},
				{icon = 43, flipX = false, text = "History"},
             ...
             onPress         = function(EventData)
                                ...
                                if selectd==1 then composer.gotoScene("Newdeploy")end
