...
local Theme =
	...
	SliderTicksCenterOffset    = 4,             -- SLIDER TICK LINES OFFSET
	TextFieldCursor            = "_",
	...
	WindowCaptionColor1        = {.78,.78,.82},    -- WINDOW TITLE CAPTION TEXT COLOR
	WindowCaptionColor2        = {.07,.07,.15},    -- WINDOW TITLE CAPTION SHADOW COLOR
	WidgetTextColor            = {.98,.98,1},      -- THE DEFAULT TEXT COLOR OF ALL WIDGETS
	ButtonTextColor            = {.98,.98,1},      -- COLOR OF BUTTON TEXT CAPTIONS
	...
	BubbleTextColor            = {.98,.98,1},      -- COLOR OF A WIDGET'S BUBBLE TEXT (SLIDERS, DRAG BUTTON ETC., WHILE BEING DRAGGED)
	SliderTickStrokeColor      = {.39,.39,.39},    -- SLIDER TICKS OUTLINE COLOR
	SliderTickFillColor        = {1,1,1},          -- SLIDER TICKS FILL COLOR
	ListItemTextColor          = {.98,.98,1},      -- DEFAULT LIST ITEM TEXT COLOR (YOU CAN ALSO SET INDIVIDUAL LIST ITEM COLORS)
	ListItemSelectedColor      = {0,0,0, .35},     -- SELECTED LIST ITEM BACKGROUND COLOR
