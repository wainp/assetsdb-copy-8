...
amodal="SRX210"
 --local tablefill =[[INSERT INTO office VALUES (NULL, ']].."oname"..[[',']].."oversion"..[[',']].."oupdate"..[[',']].."oregistered"..[[',']].."odbversion"..[['); ]]
  local tablefill =[[INSERT INTO assets VALUES (NULL, ']]..aoffice..[[',']]..aasset..[[',']]..amanufactor..[[',']]..amodal..[[',']]..aserial..[[',']]..amac..[[',']]..aip..[[',']]..aitem..[[',']]..acomments..[['); ]]
...
--_G.GUI.UnloadThemes("theme_4")
 ...
 --local titleText = display.newText( "Office Assets ", halfW, titleBar.y, native.systemFontBold, 22 )
