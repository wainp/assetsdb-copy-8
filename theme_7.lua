...
local Theme =
	...
	--------------------------------------------------------
	SwitchOnColor              = {.28,1,.28},      -- OPTIONAL COLOR OF ON/OFF SWITCHES WHEN SWITCH IS "ON"
	...
	WindowCaptionColor1        = {.98,.98,.98},    -- WINDOW TITLE CAPTION TEXT COLOR
	WindowCaptionColor2        = {.07,.07,.07},    -- WINDOW TITLE CAPTION SHADOW COLOR
	...
	SliderTickStrokeColor      = {.15,.15,.15},    -- SLIDER TICKS OUTLINE COLOR
	SliderTickFillColor        = {.78,.78,.78},    -- SLIDER TICKS FILL COLOR
	ListItemTextColor          = {1,1,1},          -- DEFAULT LIST ITEM TEXT COLOR (YOU CAN ALSO SET INDIVIDUAL LIST ITEM COLORS)
	ListItemSelectedColor      = {1,1,1,.25},      -- SELECTED LIST ITEM BACKGROUND COLOR
